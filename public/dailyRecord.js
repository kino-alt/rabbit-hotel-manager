...
function computeAllDone(items, counts) {
...
// 記録のケア（items/counts）を、その日の予定（careSchedule/careCounts）へ合わせる。
...
function reconcileCare(existingCare, schedIds, dayCounts, countableIds, removeUnfulfilled) {
